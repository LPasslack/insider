 ...
 * @author        themebubble
 */
class RS_Post_Grid_Series_Widget extends Widget_Base {

  public function get_name() {
    return 'rs-post-grid-series-widget';
  }

  public function get_title() {
    return 'Post Grid Series';
  }

  public function get_icon() {
    return 'elem_icon vc_image_post_grid_series_icon';
  }
  ...
  protected function _register_controls() {
    $this->start_controls_section(
      'post_grid_series_blog_general_settings',
      array(
  ...
  protected function render() { 
    ...
    echo rs_post_grid_series($atts, true);
...
Plugin::instance()->widgets_manager->register_widget_type( new RS_Post_Grid_Series_Widget() );