 ...
 * @author        themebubble
 */
class RS_Weekly_7_Blog_Widget extends Widget_Base {

  public function get_name() {
    return 'rs-weekly-7-blog-widget';
  }

  public function get_title() {
    return 'Weeky Top 7 Blog';
  }

  public function get_icon() {
    return 'elem_icon vc_image_weekly_top_7_icon';
  }
  ...
  protected function render() { 
    ...
    echo rs_weekly_7_blog($atts, true);

  }


}
Plugin::instance()->widgets_manager->register_widget_type( new RS_Weekly_7_Blog_Widget() );