 ...
 * @author        themebubble
 */
class RS_Hand_Picked_Blog_Widget extends Widget_Base {

  public function get_name() {
    return 'rs-hand-picked-blog-widget';
  }

  public function get_title() {
    return 'Hand Picked Blog';
  }

  public function get_icon() {
    return 'elem_icon vc_image_hand_picked_icon';
  }
  ...
  protected function _register_controls() {
    $this->start_controls_section(
      'hand_picked_blog_general_settings',
      array(
    ...
    $this->add_control(
      'trim_title',
      array(
        'label'       => esc_html__( 'Trim Title', 'magplus-addons' ),
        'type'        => Controls_Manager::SELECT,
        'default'     => 'no',
        'options'     => array(
          'no'        => 'No',
    ...
    $this->start_controls_section('section_comment_style',
      array(
        ...
        'tab'   => Controls_Manager::TAB_STYLE,
        'condition' => array('style!' => array('style4', 'style1'))
      )
    );
  ...
  protected function render() { 
    ...
    $trim_title     = $settings['trim_title'];
    $orderby        = $settings['orderby'];
    $style          = $settings['style'];

    $trim_title = ($trim_title == 'yes') ? true:false;
    ...
    switch ($style) {
      ...
      case 'style4': ?>
        <div class="row tt-post-wrap tt-handpicked-blog-style4 post-grid-view">
          <?php while ($the_query -> have_posts()) : $the_query -> the_post();?>
          <div <?php post_class('col-md-3 post-handy-picked'); ?>>
            <div class="tt-post">
              <?php magplus_post_format('magplus-medium-ver', 'img-responsive', true, ''); ?>
              <div class="tt-post-info">
                <?php magplus_blog_category($show_category); ?>
                <?php magplus_blog_title('c-h5', true, $trim_title); ?>
                <div class="empty-space marg-lg-b5"></div>
                <?php magplus_blog_post_bottom('no', $show_views); ?>
              </div>
            </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new RS_Hand_Picked_Blog_Widget() );