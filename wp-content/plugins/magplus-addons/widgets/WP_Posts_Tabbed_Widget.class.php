...
class magplus_WP_Posts_Tabbed_Widget extends WP_Widget
{
      ...
      <div class="tt-tabs-content clearfix">
        <div class="tt-tab-info active">
          ...
          <?php if(!empty($show_more_link)): ?>
            <a class="c-btn type-2" href="<?php echo esc_url($show_more_link); ?>"><?php echo esc_html(magplus_get_opt('translation-show-more')); ?></a>
          <?php endif; ?>
        </div>
  ...
  function form( $instance ) {
    ...
    $show_more_link    = isset($instance['show_more_link']) ? $instance['show_more_link'] :'';
    ?>
    ...
    <p><label for="<?php echo esc_attr($this->get_field_id('show_more_link')); ?>"><?php _e( 'Show more link:', 'magplus-pro-addons' ); ?></label>
    <input class="widefat" id="<?php echo esc_attr($this->get_field_id('show_more_link')); ?>" name="<?php echo esc_attr($this->get_field_name('show_more_link')); ?>" type="text" value="<?php echo esc_attr($show_more_link); ?>" size="3" /><span class="description" style="padding:0;"><em>Add link for show more button, leave empty to hide.</em></span></p>
    <?php
  }
}
