 ...
 *
 */
function rs_weekly_7_blog( $atts, $from_elem = false, $content = '', $id = '' ) {
  ...
  if( $cats ) {
    $args['tax_query'] = array(
      array(
        'taxonomy' => 'category',
        'field'    => 'ids',
        'terms'    => ($from_elem) ? $cats:explode(',', $cats)
      )
    );
  }
    ...
    <?php
      ...
      if( $the_query->have_posts() ):
        ...
        $the_posts[] = array(
          ...
          'post_video_url'    => get_post_meta(get_the_id(), 'post-video-url', true),
          ...
          <?php magplus_weekly_post_format($the_posts[0]['big_image'], $the_posts[0]['post_format'], $the_posts[0]['permalink'], $the_posts[0]['post_gallery'], $the_posts[0]['post_video_url'], $the_posts[0]['post_video_length'] ); ?>
            ...
            <div class="tt-post-info">
                ...
                <div class="tt-post-bottom">
                  <span><a href="#" class="tt-post-comment"><i class="material-icons">chat_bubble</i><?php echo esc_html($the_posts[0]['comment']); ?> <?php echo esc_html('Comments', 'magplus'); ?></a></span>
                  <span><a href="#" class="tt-post-views"><i class="material-icons">visibility</i>
                    <?php echo esc_html($the_posts[0]['post_views']); ?>
                  </a></span>
                </div>
            </div>
          </div>
