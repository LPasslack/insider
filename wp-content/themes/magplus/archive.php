...
$pagination_style = magplus_get_opt('archive-pagination');
$post_per_page    = ($obj->count > $post_per_page) ? $obj->count - $post_per_page:$post_per_page;
...
$layout = magplus_get_opt('archive-layout');
