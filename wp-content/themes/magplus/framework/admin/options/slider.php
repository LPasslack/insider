...
$this->sections[] = array(
  ...
  'fields' => array(
    ...
    array(
      ...
      'type' => 'select',
      'title' => esc_html__('Slider Order By', 'magplus'),
      'options' => array(
        'ID'            => esc_html__('ID','magplus'),
        'title'         => esc_html__('Title','magplus'),
        'name'          => esc_html__('Post Name','magplus'),
        'date'          => esc_html__('Date','magplus'),
        'comment_count' => esc_html__('Comments','magplus'),
        'rand'          => esc_html__('Random','magplus'),
        'modified'      => esc_html__('Last Modified','magplus'),
    ...
    array(
      ...
      'type' => 'select',
      'title' => esc_html__('Slider Order', 'magplus'),
      'options' => array(
        'DESC' => esc_html__('DESC','magplus'),
        'ASC'  => esc_html__('ASC','magplus'),
      ),
      'default' => 'DESC',
    ),
  )
