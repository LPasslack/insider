...
$this->sections[] = array(
  'title'      => esc_html__('Custom Fonts', 'magplus' ),
  'subsection' => true,
  'fields' => array(
    array(
      'id'           => 'custom_fonts',
      'type'         => 'repeater',
      'default'      => array(),
      'title'        => esc_html__( 'Upload Custom Fonts', 'magplus' ),
      'desc'         => esc_html__( 'It is simple. Only add your custom fonts and click to save. After you can check "Font Family" selector. Do not forget to Save!', 'magplus' ),
      'group_values' => true, 
      'fields'     => array(
        array(
          'id'          =>'name',
          'type'        => 'text',
          'placeholder' => esc_html__('Arial', 'magplus'),
          'title'       => esc_html__('Font Family Name', 'magplus'),
        ),
        array(
          'id'    =>'ttf',
          'type'  => 'media',
          'url'   => true,
          'mode'  => false,
          'title' => esc_html__('Upload .ttf (Optional)', 'magplus'),
        ),
        array(
          'id'    =>'eot',
          'type'  => 'media',
          'url'   => true,
          'title' => esc_html__('Upload .eot (Optional)', 'magplus'),
        ),
        array(
          'id'    =>'svg',
          'type'  => 'media',
          'url'   => true,
          'title' => esc_html__('Upload .svg (Optional)', 'magplus'),
        ),
        array(
          'id'    =>'woff',
          'type'  => 'media',
          'mode'  => false,
          'url'   => true,
          'title' => esc_html__('Upload .woff (Optional)', 'magplus'),
        ),
        array(
          'id'    =>'woff2',
          'type'  => 'media',
          'mode'  => false,
          'url'   => true,
          'title' => esc_html__('Upload .woff2 (Optional)', 'magplus'),
        ),
      )
    )
  )
