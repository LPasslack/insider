...
$this->sections[] = array(
  ...
  'fields' => array(
    ...
    array(
      'id'      =>'translation-zero-view',
      'type'    => 'text',
      'title'   => esc_html__('0 View', 'magplus'),
      'default' => '0 View'
    ),
    array(
      'id'      =>'translation-one-view',
      'type'    => 'text',
      'title'   => esc_html__('1 View', 'magplus'),
      'default' => '1 View'
    ),
    array(
    ...
    array(
      'id'      =>'translation-zero-comment',
      'type'    => 'text',
      'title'   => esc_html__('0 Comment', 'magplus'),
      'default' => '0 Comment'
    ),
    array(
      'id'      =>'translation-one-comment',
      'type'    => 'text',
      'title'   => esc_html__('1 Comment', 'magplus'),
      'default' => '1 Comment'
    ),
    array(
    ...
    array(
      'id'      =>'translation-downloads',
      'type'    => 'text',
      'title'   => esc_html__('Downloads', 'magplus'),
      'default' => 'Downloads'
    ),
    array(
      'id'      =>'translation-download-now',
      'type'    => 'text',
      'title'   => esc_html__('Download Now', 'magplus'),
    ...
    array(
      'id'      =>'translation-next-up',
      'type'    => 'text',
      'title'   => esc_html__('Next Up', 'magplus'),
      'default' => 'Next Up'
    ),
    array(
    ...
    array(
      'id'      =>'translation-no-post-found',
      'type'    => 'text',
      'title'   => esc_html__('Sorry No Post Found !', 'magplus'),
      'default' => 'Sorry No Post Found !'
    ),
    array(
