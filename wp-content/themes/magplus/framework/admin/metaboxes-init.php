...
function magplus_redux_add_metaboxes($metaboxes) {
  ...
  $metaboxes[] = magplus_redux_get_link_post_metaboxes();
  $metaboxes[] = magplus_redux_get_post_metaboxes();
  $metaboxes[] = magplus_redux_get_post_adv_metaboxes();
  $metaboxes[] = magplus_redux_get_page_template_blog_metaboxes();
 ...
 * @return type
 */
function magplus_redux_get_page_template_blog_metaboxes() {
  ...
  return array(
    'id' => 'magplus-template-blog-options',
    'title' => esc_html__('Blog Options', 'magplus'),
 ...
 * @return type
 */
function magplus_redux_get_link_post_metaboxes() {

  // Variable used to store the configuration array of sections
  $sections = array();

  // Metabox used to overwrite theme options by page
  require get_theme_file_path('framework/admin/metaboxes/post-download.php');

  return array(
    'id' => 'magplus-download-post-options',
    'title' => esc_html__('Download Post Options', 'magplus'),
