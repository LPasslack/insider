...
<section class="coment-item">
  ...
  <h4 class="tt-title-block-2 size-2 color-2"><?php comments_number(magplus_get_opt('translation-zero-comment'), magplus_get_opt('translation-one-comment'), '% '.magplus_get_opt('translation-comments') ); ?></h4>
  ...
  <div class="tt-comment-form tt-comment-form clearfix">
    ...
    <?php
      ...
      $args = array(
        ...
        'comment_field'     => '
          <textarea name="comment" id="text" ' . $aria_req . ' class="c-area type-2 form-white placeholder" rows="10" placeholder="'.magplus_get_opt( 'translation-your-comment').'"></textarea>
          ',
          ...
          array(
            'author' => '
                <div class="row"><div class="col-sm-6">
                  <!-- Name -->
                  <input type="text" name="author" id="name" ' . $aria_req . ' class="c-input placeholder" placeholder="'.magplus_get_opt( 'translation-name').'" maxlength="100">',
